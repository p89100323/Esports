                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                        <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title" style="text-align: center;">Sports / Date</th>
                                            </tr>
                                        </thead>
                                        ...
                                        ?>             
                                     <tr>
                                      <form action="checkcalendar.php" method="post" name="form2" target="_self" id="form2">
                                        <td  style="text-align:center;"> 
                                            
                                                                                     
                                          Date: <input required title="You must select a date" class="datepicker" type="text" name="sdate">
                                                <script>
                                                ...
                                                <select name="ssport" id="ssport" >
                                                <?php
                                                while ($row=mysqli_fetch_array($result)){
                                                echo "<option value=$row[bil]>$row[sport]</option>";
                                                }
                                                ?>
                                                </select>
